            ...
            <form class="withdraw-form">
                ...
                <div class="c side">
                    ...
                    <div class="row fee clearfix">
                        ...
                        <div class="c value">-23 <a class="help" href="#"></a></div>
                    </div>
                    <div class="row rest clearfix">
                        <div class="c label">Остаток</div>
                        <div class="c value">3456 <a class="help" href="#"></a></div>
                    </div>
                    <div class="actions">
