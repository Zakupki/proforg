 ...
 *
 * @param string $extra Extra URL data
 * @return string
 */
function retUrl($extra = '')
{
    return base64_encode(request()->getUrl().$extra);
}

/**
 * Extract return url if available
 *
 * @param mixed $default Default route
 * @return array|string
 */
function getRetUrl($default = array('admin'))
{
    return (request()->getParam('returnUrl') ? base64_decode(request()->getParam('returnUrl')) : $default);
}