...
class CUploadedFile extends CComponent
{
    ...
    public static function getInstance2($model, $attribute)
    {
        return self::getInstanceByName2(CHtml::resolveName($model, $attribute));
    }
    ...
    public static function getInstanceByName2($name)
    {
        //echo $name;
        //if(null===self::$_files){
            self::prefetchFiles();
