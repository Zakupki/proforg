 ...
 *
 * @method Units active
 * @method Units cache($duration = null, $dependency = null, $queryCount = 1)
 * @method Units indexed($column = 'id')
 * @method Units language($lang = null)
 * @method Units select($columns = '*')
 * @method Units limit($limit, $offset = 0)
 * @method Units sort($columns = '')
 */
