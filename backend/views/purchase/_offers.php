...
$model=new Offer;
$products=Offer::model()->with('tag')->sort('t.id DESC')->findAll('t.pid=:pid OR t.id=:pid',array('pid'=>$_GET['id']));
        ...
        array(
            ...
            'buttons' => array(
                'clone' => array(
                    ...
                    'url' => 'url("offer/clone", array("id" => $data->id, "originUrl" => retUrl("#form-paragraphs")))',
